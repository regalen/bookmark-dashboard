...
export function BookmarkCard({ bookmark, onEdit, onDelete, onTogglePin, onTagClick }: Props) {
    ...
    <article className="card">
      <div className="card-header">
        <div className="card-title-wrap">
          <h2 className="card-title" title={bookmark.title}>{bookmark.title}</h2>
        </div>
        <div className="card-actions">
          ...
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill={bookmark.pinned ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
