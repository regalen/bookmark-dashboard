...
interface Props {
  ...
  onReorder: (newOrder: Group[]) => void;
  onClose: () => void;
}

export function ManageGroupsModal({ groups, bookmarks, onAdd, onRename, onDelete, onReorder, onClose }: Props) {
    ...
    >
      <div className="modal">
        <div className="modal-header">
          <h2 className="modal-title">Manage Groups</h2>
        ...
        <div className="manage-groups-body">
          ...
          <div className="manage-groups-add">
            ...
            />
            <button className="btn-primary" onClick={handleAdd} disabled={!newGroupName.trim()}>
              Add
            </button>
          </div>
        </div>
